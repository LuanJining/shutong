...
docker exec -i platform-postgres psql -U postgres -c "CREATE DATABASE workflow;"
...
docker exec -i platform-postgres psql -U postgres -d workflow -c "DROP SCHEMA public CASCADE; CREATE SCHEMA public; GRANT ALL ON SCHEMA public TO postgres; GRANT ALL ON SCHEMA public TO public;"
echo "重新执行初始化脚本..."
