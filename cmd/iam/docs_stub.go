...
// @Accept json
// @Produce json
// @Param request body iamhandler.LoginRequest true "Login credentials"
// @Success 200 {object} iamhandler.LoginResponse
// @Failure 400 {object} iamhandler.ErrorResponse
// @Failure 401 {object} iamhandler.ErrorResponse
...
// @Accept json
// @Produce json
// @Param request body iamhandler.CreateUserRequest true "Create user"
...
// @Param request body iamhandler.UpdateUserRequest true "Update payload"
// @Success 200 {object} iam.User
// @Failure 400 {object} iamhandler.ErrorResponse
// @Failure 404 {object} iamhandler.ErrorResponse
...
// @Accept json
// @Produce json
// @Param request body iamhandler.CreateRoleRequest true "Create role"
...
// @Accept json
// @Produce json
// @Param request body iamhandler.CreateSpaceRequest true "Create space"
...
// @Accept json
// @Produce json
// @Param request body iamhandler.CreatePolicyRequest true "Create policy"
