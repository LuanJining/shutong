...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/spaces/{id}/members/{role_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.StartWorkflowRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/workflow/tasks/{id}/approve": {
            "post": {
                "description": "审批通过任务",
                "consumes": [
                    "application/json"
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ApproveTaskRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.RejectTaskRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TransferTaskRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateWorkflowRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.CreateStepRequest": {
            ...
            "properties": {
                "approval_strategy": {
                    "description": "审批策略: any, all, majority",
                    "type": "string"
                },
                "approver_id": {
                    "type": "integer"
